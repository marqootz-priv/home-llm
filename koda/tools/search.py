"""Web search tool for Koda: Brave (if API key set) or DuckDuckGo (free fallback)."""
import httpx
...
def search_web(query: str) -> dict:
    """Search the web. Uses Brave if BRAVE_API_KEY is set, else DuckDuckGo (free). Returns top 3 results as title, snippet, url."""
